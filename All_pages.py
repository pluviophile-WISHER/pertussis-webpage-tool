...
with st.sidebar:
    ...
    selected = option_menu(menu_title="        Menu", options=menu,
                         icons=['house', 'person', 'file-plus'],  # Changed icons to more suitable ones
                         menu_icon="list", default_index=0,
                         styles={
        "container": {"padding": "5!important", "background-color": "#fafafa"},
        "icon": {"color": "gray", "font-size": "18px"},  # Changed color to gray
        "nav-link": {"font-size": "15px", "text-align": "left", "margin": "0px", "--hover-color": "#eee"},
        "nav-link-selected": {"background-color": "#00A8C1", "font-weight": "normal"},  # Changed color to darker orange
    })
