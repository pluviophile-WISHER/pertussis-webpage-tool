...
def View_data_file():
    ...
    path_PNH = r'Pertussis_data_consolidation/positive_negative_physical_examination.xlsx'  
    data_PNH = pd.read_excel(path_PNH)
    tab1.dataframe(data_PNH, width=1400, height=710) 

    path_PN = r'Pertussis_data_consolidation/positive_and_negative.xlsx'
    data_PN = pd.read_excel(path_PN)
    tab2.dataframe(data_PN, width=1400, height=710)
    
    path_PH = r'Pertussis_data_consolidation/positive_and_physical_examination.xlsx'
